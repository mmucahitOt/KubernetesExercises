...
docker tag todo_app:latest $DOCKER_REGISTRY/todo_app:latest
echo "Docker image tagged"

# Push the Docker image to Docker Hub
docker push $DOCKER_REGISTRY/todo_app:latest
...
# !! PORT argument is not working
kubectl create deployment todo-app-deployment --image=$DOCKER_REGISTRY/todo_app:latest --port=$PORT
